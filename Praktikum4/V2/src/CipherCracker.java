...
//
//        CipherDecoder decoder = new CipherDecoder(key, encodedText);
//
//        return decoder.decode(new VigenereDecodeStrategy());
//    }
//
...
//        CipherDecoder decoder = new CipherDecoder(new char[]{(char)((int) characterForE - (int) 'E' + 65)}, encodedText);
//
//        return decoder.decode(new CaesarDecodeStrategy());
//    }
}
