...
public class CipherCracker {
    ...
    public static char[] crackVigenere(char[] encodedText){
        ...
        AbstractCipherActor encoder1 = builder.build(key, encodedText, true, CipherUtil.VIGENERE_CIPHER);
        return encoder1.action();
    }
    ...
    public static char[] crackCaesar(char[] encodedText){
        ...
        CipherActorBuilder builder = new CipherActorBuilder();
        AbstractCipherActor encoder1 = builder.build(new char[]{(char)((int) characterForE - (int) 'E' + 65)}, encodedText, true, CipherUtil.CAESAR_CIPHER);
        return encoder1.action();
    }
}
